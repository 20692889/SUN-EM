function [Const, FEKO_data] = parseGEOout(Const)

    % parseGEOout
    %   Date: 2020.02.20
    %   Usage:
    %       [Const, FEKO_data] = parseGEOout(Const)
    %
    %   Input Arguments:
    ...
    %
    %   Description:
    %       Reads in a FEKO *.out file and extracts the geometry FEKO data
    %       (frequencies, mesh info)
...
%         end
        ...
        found_metallic_triangles = contains(line,'DATA OF THE METALLIC TRIANGLES');
